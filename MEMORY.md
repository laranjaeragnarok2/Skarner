...
- **2026-02-09:** Blindagem do sistema realizada. Configurado failover de contas (`auth.order`), escada de modelos (`fallbacks`) e migração para Memória Local (`local provider`).
